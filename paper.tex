...
\begin{figure}[tp]
  ...
  \caption[]{$S_3$ function for anisotropic media (on the left) elongated along
    the axis $Y$. Anisotropicity of the medium can be seen on a heatmap of $S_3$
    function (in the middle). An average of 10 $S_3$ evaluations of the medium
    rotated by a random angle is on the right.}
  \label{fig:aniso}
\end{figure}
