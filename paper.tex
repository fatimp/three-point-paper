...
\begin{figure*}[tp]
  ...
  \caption[]{A comparison of $F_{sss}$ function calculated using our approach
    with its precise values. \highlight{Make dumbbell around 20 percent smaller}}
...
\begin{table*}[!htp]
  ...
  \begin{tabular}{|c|c|c|c|c|c|}
    ...
    Soil & Reconstruction & $500 \times 500 \times 500$ & 0.72 & 0.9431 & Digitally
    magnified \\
    Shale & Reconstruction & $160 \times 160 \times 160$ & 2.25 & 0.8912 & \\
    Sandstone & SEM &  $1280 \times 869$ & 0.10 & 0.9613 & \\
    \hline
  \end{tabular}
  \caption{Summary of samples used for calculation of correlation functions. \highlight{Remove comments?}}
  \label{tab:summary}
\end{table*}
