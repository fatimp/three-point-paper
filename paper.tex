...
\cref{fig:sss-ellipse-error}. Maximal relative error in the area bound by
inequations $x > 0.1$, $y > 0.1$ and $f(x, y) < 0.78$ is about 10\%.
\begin{figure*}[tp]
  \centering
  \subfigure[The ellipse-like object used in testing of $F_{sss}$ computation]{
    \includegraphics[width=0.45\linewidth]{images/ellipse.png}
    \label{fig:sss-ellipse}}
  \hfill
  \subfigure[Relative error of computation]{
    \includegraphics[width=0.45\linewidth]{images/ellipse-sss-diff.png}
    \label{fig:sss-ellipse-error}}
  \vskip\baselineskip
  \subfigure[$F_{sss}$: precise]{
    \includegraphics[width=0.45\linewidth]{images/ellipse-sss.png}}
  \hfill
  \subfigure[$F_{sss}$: calculated with our approach]{
    \includegraphics[width=0.45\linewidth]{images/ellipse-sss-julia.png}}
