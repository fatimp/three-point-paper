...
representing cubes of 2-phase porous media. The number of voxels in each cube
increases from $1.25 \cdot 10^5$ to $2.7 \cdot 10^7$ linearly. The time of execution
is measured for each function executed on a CPU and a GPU. Hardware and software
components used for testing are listed in \cref{tab:machine}.
\begin{table*}[!htp]
  \centering
  \begin{tabular}{|c|c|}
