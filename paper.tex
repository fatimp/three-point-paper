...
anisotropicity present in the sample will be featured in a produced correlation
...
anisotropicity parallel to one of the axes, so anisotropicity can be better
featured in the correlation function \cref{fig:aniso}.
\begin{figure*}[tp]
  \centering
...
\begin{figure*}[tp]
  \centering
  \subfigure[Limestone]{
    \includegraphics[width=0.4\linewidth]{images/carb.png}
...
\begin{figure*}[tp]
  \centering
  \includegraphics[width=0.4\linewidth]{images/carb.npy-surf3.png}
  \hfill
  \includegraphics[width=0.4\linewidth]{images/carb.npy-surf2void.png}
  \vskip\baselineskip
  \includegraphics[width=0.4\linewidth]{images/carb.npy-surfvoid2.png}
  \hfill
  \includegraphics[width=0.4\linewidth]{images/carb.npy-s3.png}
  \vskip\baselineskip
  \includegraphics[width=0.4\linewidth]{images/carb.npy-c3.png}
