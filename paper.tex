...
\begin{figure}[ht]
  ...
  \caption[]{Pattern used for calculation of $S_3$ function in out
    ...
    $Y$ or $Z$ and have lengths $r_1$ and $r_2$ respectively. Red triangles
    contribute to $S_3(2, 3)$ and blue triangles contribute to $S_3(1, 1)$.}
  \label{fig:pattern}
\end{figure}
...
samples for which the criterion $C_{0.5} > 0.97$ holds. Images of the samples
are on \cref{fig:samples}. On plots of correlation functions we provide a family
of curves with the first argument of the correlation function being fixed. For
two highly anisotropic samples (the soil and the shale) we provide heatmaps of
$S_3$ correlation function where anisotropicity can be easily seen. These two
samples was preliminary rotated by $\frac{\pi}{4}$ around the axis $Z$ before
...
\begin{table}[!htp]
  ...
  \begin{tabular}{|c|c|c|c|c|}
    ...
    Soil & XCT & $160 \times 160 \times 160$ & \textcolor{red}{2.25} & 0.9210 \\
    Shale & XCT & $160 \times 160 \times 160$ & \textcolor{red}{2.25} & 0.8912 \\
...
\begin{figure*}[tp]
  \centering
  \subfigure[Shale]{
    \includegraphics[width=0.45\linewidth]{images/shale-c3.png}
    \label{fig:shale-s3}}
  \hfill
  \subfigure[Soil]{
...
\begin{figure}[tp]
  \centering
  \includegraphics[width=0.3\linewidth]{images/aniso.png}
  \hfill
  \includegraphics[width=0.3\linewidth]{images/aniso-s3.png}
  \hfill
  \includegraphics[width=0.3\linewidth]{images/aniso-s3-avg.png}
