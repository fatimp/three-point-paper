...
CFs with $n>3$ are not clear. Nonetheless, developed algorithms and code are
...
package \code{CorrelationFunctions.jl} [Postnicov et al., 2024,
  Comp.Phys.Commun., 299, 109134]. As described in this paper, 3-point CFs
...
\begin{figure*}[ht]
  \centering
  \subfigure[2-point CF]{
    \includegraphics[width=0.45\linewidth]{images/2p.png}}
  \hfill
  \subfigure[3-point CF]{
    \includegraphics[width=0.45\linewidth]{images/3p.png}}
...
\begin{figure*}[ht]
  \centering
  \subfigure[Arbitrary]{
    \includegraphics[width=0.3\linewidth]{images/arbitrary.png}}
  \hfill
  \subfigure[Weblike]{
    \includegraphics[width=0.3\linewidth]{images/web.png}}
  \hfill
  \subfigure[Right-triangular]{
    \includegraphics[width=0.3\linewidth]{images/right.png}}
...
The results of the comparison are shown in \cref{fig:comparison-patterns}. For
...
\begin{figure*}[ht]
  \centering
  \subfigure[Isosceles with right angle]{
    \includegraphics[width=0.4\linewidth]{images/isosceles.png}
    \label{fig:cp-isosceles}}
  \hfill
  \subfigure[Equilateral]{
    \includegraphics[width=0.4\linewidth]{images/equilateral.png}
    \label{fig:cp-equilateral}}
  \vskip\baselineskip
  \subfigure[With random rotations]{
    \includegraphics[width=0.4\linewidth]{images/equilateral-avg.png}
    \label{fig:cp-equilateral-avg}}
  \hfill
  \subfigure[Comparison plot]{
    \includegraphics[width=0.4\linewidth]{images/alltogether.png}
    \label{fig:cp-comp}}
