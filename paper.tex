...
with nearest-neighbor interpolation which affects quality of computations as
...
produce images of the noise rotated around $Z$ axis by $\theta$ radians by
