...
ax1 = plt.gca()
ax2 = ax1.twinx()
p1, = ax1.plot(xs, errsss_300, 'b.-', label = r'$F_{sss}, 300 \times 300 \times 300$', linewidth = 3, markersize = 10)
p2, = ax1.plot(xs, errsss_600, 'g.-', label = r'$F_{sss}, 600 \times 600 \times 600$', linewidth = 3, markersize = 10)
p3, = ax2.plot(xs, errs3_300, 'r.-', label = r'$S_3, 300 \times 300 \times 300$', linewidth = 3, markersize = 10)
p4, = ax2.plot(xs, errs3_600, 'm.-', label = r'$S_3, 600 \times 600 \times 600$', linewidth = 3, markersize = 10)
