...
ax1 = plt.gca()
ax2 = ax1.twinx()
p1, = ax1.plot(xs, errsss_300, 'bo-', label = r'$F_{sss}, 300^3$', linewidth = 3, markersize = 10)
p2, = ax1.plot(xs, errsss_600, 'g*-', label = r'$F_{sss}, 600^3$', linewidth = 3, markersize = 10)
p3, = ax2.plot(xs, errs3_300, 'r^-', label = r'$S_3, 300^3$', linewidth = 3, markersize = 10)
p4, = ax2.plot(xs, errs3_600, 'ms-', label = r'$S_3, 600^3$', linewidth = 3, markersize = 10)
...
ax1.legend(handles = [p1, p2, p3, p4], loc='best', bbox_to_anchor=(0.5, 0.03, 0.4, 0.4))
plt.savefig('roterror.png')
